...
public class TerminatingAllExecutorTasks {
	...
	public static void main(String[] args) throws Exception {
		...
		LoopTaskA task1 = new LoopTaskA(); //blocking runnable
		LoopTaskF task2 = new LoopTaskF(); //non-blocking runnable
		FactorialTaskB task3 = new FactorialTaskB(30, 500); //blocking callable
		CalculationTaskC task4 = new CalculationTaskC(); //non-blocking callable
		CalculationTaskB task5 = new CalculationTaskB(2, 3, 9000); //blocking callable
		...
		Future<TaskResults<String,Integer>> t5Future =execService.submit(task5);
		...
		try{
		   System.out.println("[" + currentThreadName + "] 'CalcTaskB-1' Result  = " +
				  t5Future.get());
